...
# def main_worker(args,cfg):
    ...
    checkpoint_name = getattr(args, 'checkpoint_name', 'model_best.pth.tar')
    print('==> Test checkpoint: {}'.format(checkpoint_name))
    checkpoint = load_checkpoint(osp.join(args.logs_dir, checkpoint_name))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-name', type=str, default='model_best.pth.tar',
                        help='Checkpoint file inside --logs-dir to evaluate.')
