...
from clustercontrast.models.gprd_gap_memory import gprd_ranking_loss
...
class ClusterContrastTrainer_GPRD(object):
    def __init__(self, encoder, memory=None,matcher_rgb = None,matcher_ir = None):
        ...
        self.GPRD_gap_floor = 0.06
        self.GPRD_gap_weight = 0.0
    ...
    def set_gprd_teacher(self, rgb_to_ir, ir_to_rgb, base_weight,
        ...
        self.GPRD_gap_floor = float(gap_floor)
        self.GPRD_gap_weight = float(gap_weight)
    ...
    def train(self, epoch, data_loader_ir,data_loader_rgb, optimizer, print_freq=10, train_iters=400):
        ...
        GPRD_gap_log = AverageMeter()
        GPRD_gap_floor_loss_log = AverageMeter()
...
##########################V4 wise neighbor
            ...
            if self.GPRD_enabled and self.GPRD_active_weight > 0.0:
                GPRD_rgb_loss, GPRD_rgb_stats = gprd_ranking_loss(
                    ...
                    gap_floor=self.GPRD_gap_floor,
                    gap_weight=self.GPRD_gap_weight,
                ...
                if active_stats:
                    ...
                    GPRD_gap = sum(stats['gap'] for stats in active_stats) / denom
                    GPRD_gap_floor_loss = sum(stats['gap_floor_loss'] for stats in active_stats) / denom
            ...
            GPRD_gap_log.update(GPRD_gap)
            GPRD_gap_floor_loss_log.update(GPRD_gap_floor_loss)
