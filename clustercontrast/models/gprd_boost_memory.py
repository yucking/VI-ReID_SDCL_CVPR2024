"""Adaptive Graph-Preserved Reciprocal Distillation (GPRD-BOOST).
...
def gprd_ranking_loss(student_features: torch.Tensor,
                      ...
                      negative_ceiling_weight: float = 0.08) -> Tuple[torch.Tensor, Dict[str, float]]:
    ...
    prelim_neg_sim = sim.masked_fill(~reliable_negative_mask, -10000.0)
    prelim_hard_neg = tau * torch.logsumexp(prelim_neg_sim / tau, dim=1)
    ...
    neg_sim = sim.masked_fill(~reliable_negative_mask, -10000.0)
