...
from clustercontrast.models.fgrd_memory import fgrd_ranking_loss
...
class ClusterContrastTrainer_FGRD(object):
    def __init__(self, encoder, memory=None,matcher_rgb = None,matcher_ir = None):
        super(ClusterContrastTrainer_FGRD, self).__init__()
        ...
        self.fgrd_hard_negative_count = 0
    ...
    def set_fgrd_teacher(self, rgb_to_ir, ir_to_rgb, base_weight,
        ...
        self.fgrd_hard_negative_count = int(rgb_to_ir.hard_negative_count)
...
##########################V4 wise neighbor
            ...
            if self.fgrd_enabled and self.fgrd_active_weight > 0.0:
                fgrd_rgb_loss, fgrd_rgb_stats = fgrd_ranking_loss(
                ...
                fgrd_ir_loss, fgrd_ir_stats = fgrd_ranking_loss(
                ...
                if active_terms:
                    ...
                    loss = loss + self.fgrd_active_weight * fgrd_loss
            ...
            if (i + 1) % print_freq == 0:
                ...
                print('[FGRD] epoch={} fgrd_loss={:.6f} active_weight={:.6f} '
                      ...
                      'listwise={:.4f} pairwise={:.4f}'.format(
                          ...
                          self.fgrd_hard_negative_count, fgrd_listwise_log.avg,
