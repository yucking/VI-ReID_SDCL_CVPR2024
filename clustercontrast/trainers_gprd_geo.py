...
from clustercontrast.models.gprd_geo_memory import gprd_ranking_loss
...
##########################V4 wise neighbor
            ...
            if self.GPRD_enabled and self.GPRD_active_weight > 0.0:
                ...
                if GPRD_rgb_s_stats['active_rows'] > 0.0:
                    active_terms.append((GPRD_rgb_s_loss, 0.5))
                    active_stats.append(GPRD_rgb_s_stats)
                if GPRD_ir_s_stats['active_rows'] > 0.0:
                    active_terms.append((GPRD_ir_s_loss, 0.5))
