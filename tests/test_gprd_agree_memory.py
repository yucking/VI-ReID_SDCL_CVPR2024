...
_MODULE_PATH = (Path(__file__).resolve().parents[1] /
                'clustercontrast' / 'models' / 'gprd_agree_memory.py')
_SPEC = importlib.util.spec_from_file_location(
    'gprd_agree_memory_under_test', _MODULE_PATH)
_gprd_agree_memory = importlib.util.module_from_spec(_SPEC)
sys.modules[_SPEC.name] = _gprd_agree_memory
_SPEC.loader.exec_module(_gprd_agree_memory)

GPRDRelation = _gprd_agree_memory.GPRDRelation
build_gprd_teacher = _gprd_agree_memory.build_gprd_teacher
gprd_ranking_loss = _gprd_agree_memory.gprd_ranking_loss
...
if __name__ == '__main__':
    ...
    print('GPRD-AGREE smoke test passed')
