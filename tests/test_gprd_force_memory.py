...
_MODULE_PATH = (Path(__file__).resolve().parents[1] /
                'clustercontrast' / 'models' / 'gprd_force_memory.py')
_SPEC = importlib.util.spec_from_file_location(
    'gprd_force_memory_under_test', _MODULE_PATH)
_gprd_force_memory = importlib.util.module_from_spec(_SPEC)
sys.modules[_SPEC.name] = _gprd_force_memory
_SPEC.loader.exec_module(_gprd_force_memory)

GPRDRelation = _gprd_force_memory.GPRDRelation
build_gprd_teacher = _gprd_force_memory.build_gprd_teacher
merge_gprd_teacher_cache = _gprd_force_memory.merge_gprd_teacher_cache
gprd_ranking_loss = _gprd_force_memory.gprd_ranking_loss
